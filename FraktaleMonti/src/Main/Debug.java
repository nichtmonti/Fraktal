...
public class Debug {
	static double xscroll=0;
	static double yscroll=0;
	static int zoomP=3;
	static int zoomF=1;
	
	static int swidth=2500;
	static int sheight=(int)Math.ceil(swidth);
	...
	public static void main(String[] args) {
		...
		String[] fun1 = {"{{.5,0},{0,.5}}" , "{{ 0, .5}}"};
		String[] fun2 = {"{{0.81,-.58},{0.58 , 0.81}}","{{0,0}}"};
		String[] fun3 = {"{{-1,0},{0,1}}" , "{{-.0, -0}}"};
		String[] fun4 = {"{{1,0},{0,-1}}" , "{{-.0, -0}}"};		
		...
		linearTransFrak linFrak = new linearTransFrak(xscroll-w, xscroll+w, yscroll-h, yscroll+h, 200, funs);
		linFrak.setItera(12);
		linFrak.update();
